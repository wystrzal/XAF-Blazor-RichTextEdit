...
using Blazor_RichTextEdit.Blazor.Server.Services;

namespace Blazor_RichTextEdit.Blazor.Server {
    public partial class Blazor_RichTextEditBlazorApplication : BlazorApplication {
        public Blazor_RichTextEditBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void Blazor_RichTextEditBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
